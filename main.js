...
function showStepResultModal(isCorrect, stepNum) {
  ...
  const stepExplanations = {
    ...
    2: "図のようにマスを移動させることで7つ目の謎の答えが現れるので、それがこのクロスワードの答えとなります。",
    3: "小問の「うらがえす」というボタン、をおして現れる図形を並べる問題でした。指示通りに図形を並べると、新たな指示がどんどん出てきます。その通りに読むと最終的に「矢印の先下から」があらわれるので、「下」という文字に陰がついていることから重ねた時に下になっているものから順に矢印の先にある文字を読むことで、答えの「こめっと06」にたどり着けます。",
  };
